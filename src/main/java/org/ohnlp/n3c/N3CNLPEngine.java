...
public class N3CNLPEngine {
    ...
    public static void main(String[] args) throws UIMAException, IOException {
        ...
        AnalysisEngineDescription xnWriter =
                AnalysisEngineFactory.createEngineDescription(
                        MedXNCC.class,
                        MedXNCC.PARAM_OUTPUT_FILE,
                        outputDirPath.resolve("medxn_out.txt").toString(), MedXNCC.PARAM_DELIMITER, "|");

        SimpleCliPipeline.runPipeline(reader, ab.createAggregateDescription(),  writer, xnWriter);
